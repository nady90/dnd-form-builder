    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of ga(t))
        !ya.call(e, i) &&
          ...
          on(e, i, {
            get: () => t[i],
            enumerable: !(n = fa(t, i)) || n.enumerable,
          });
    return e;
  };
var Ue = (e, t, r) => (
  ...
  var ci = (e, t) => () => (
    ...
    Ea = ci((e) => {
      ...
      function g(C) {
        ...
        return (
          B === 2 &&
            ((S = (r[C.charCodeAt(Q)] << 2) | (r[C.charCodeAt(Q + 1)] >> 4)),
            (I[L++] = S & 255)),
          B === 1 &&
            ((S =
              (r[C.charCodeAt(Q)] << 10) |
      ...
      function k(C) {
        for (
          var S, M = C.length, _ = M % 3, B = [], I = 16383, L = 0, oe = M - _;
          L < oe;
          L += I
        )
...
var Ja = {
  enabled:
    !Ii && Oi == null && Di !== "dumb" && ((dn != null && dn !== "0") || Mi),
};
function j(e, t) {
...
R.inverseTangent = R.atan = function () {
  ...
  for (
    N = !1, t = Math.ceil(a / D), n = 1, l = f.times(f), s = new g(f), i = f;
    e !== -1;
  ...
  return (
    r && (s = s.times(2 << (r - 1))),
    (N = !0),
    O(s, (g.precision = h), (g.rounding = T), !0)
  );
};
R.isFinite = function () {
  return !!this.d;
...
R.minus = R.sub = function (e) {
  ...
  if (
    ((f = k.d), (T = e.d), (a = C.precision), (l = C.rounding), !f[0] || !T[0])
  ) {
    if (T[0]) e.s = -e.s;
...
R.precision = R.sd = function (e) {
  ...
  return (
    r.d ? ((t = ho(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN),
    t
  );
};
R.round = function () {
...
R.times = R.mul = function (e) {
  ...
  return (
    ...
    (e.d = o),
    (e.e = vr(o, r)),
    N ? O(e, h.precision, h.rounding) : e
  );
};
...
R.toNearest = function (e, t) {
  ...
  return (
    e.d[0]
      ? ((N = !1), (r = $(r, e, 0, t, 1).times(e)), (N = !0), O(r))
      : ((e.s = r.s), (r = e)),
    r
  );
};
...
var $ = (function () {
  ...
  return function (n, i, o, s, a, l) {
    ...
    if (
      (V[h] > (Y[h] || 0) && g--,
      o == null
        ? ((Q = o = or.precision), (s = or.rounding))
        : a
          ? (Q = o + (n.e - i.e) + 1)
          : (Q = o),
      Q < 0)
  ...
  e: if (t != null) {
    ...
    if (
      ...
      return (
        (h.length = 0),
        f
          ? ((t -= e.e + 1), (h[0] = W(10, (D - (t % D)) % D)), (e.e = -t || 0))
          : (h[0] = e.e = 0),
        e
      );
    if (
...
function An(e, t) {
  ...
  for (
    t == null ? ((N = !1), (l = C)) : (l = t), a = new T(0.03125);
    e.e > -2;
...
function Cn(e, t, r, n) {
  ...
  if (
    (C
      ? (ne(r, 1, Me), n === void 0 ? (n = k.rounding) : ne(n, 0, 8))
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...
          argument: {
            ...n.argument,
            typeNames: Fu(o.argument.typeNames, n.argument.typeNames),
          },
        })
      : t.set(i, n);
  }
...
function Ku(e, t) {
  ...
  if (a) {
    ...
    if (e.dependentArgumentPath) {
      ...
      t.addErrorMessage(
        (f) =>
          `Argument \`${f.green(o)}\` is required because argument \`${f.green(l)}\` was provided.`,
      );
    }
  }
}
    ...
    constructor(n) {
      ...
      let o = e.relativeEnvPaths && {
          rootEnvPath:
            ...
            mr.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
          schemaEnvPath:
            e.relativeEnvPaths.schemaEnvPath &&
            mr.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
        },
        s;
      if (n?.adapter) {
        s = n.adapter;
